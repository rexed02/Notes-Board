...
class NotesBoardDocker(DockWidget):
    ...
    def activate_notes_board(self):
        ...
        self.is_active = True
        self.toggle_button.setText("Desactivate Notes Board")
    ...
    def deactivate_notes_board(self):
        ...
        result = QMessageBox.question(None, "Desactivate Notes Board", "¿Do you want to contiunue?", QMessageBox.Yes | QMessageBox.No)
